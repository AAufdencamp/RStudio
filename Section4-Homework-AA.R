...
#
# <put your code here>
ft<-rbind(KobeBryant_FT, JoeJohnson_FT,LeBronJames_FT, CarmeloAnthony_FT, DwightHoward_FT, ChrisBosh_FT, ChrisPaul_FT,KevinDurant_FT, DerrickRose_FT, DwayneWade_FT )
ft
colnames(ft)<- Seasons
ft
...
#Player style excluding Free Trows(1 pt each). Assume That 
#means getting Points data from Basketball Data. Normalize using 
#FieldGoals

pswoft<- (Points - ft) / FieldGoals
pswoft
